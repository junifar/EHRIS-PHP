                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{$errors->has('handphone')?'has-error':''}}">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text('handphone',null, ['class' => 'form-control', 'placeholder' => 'Handphone']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('status', $statuses, null, ['class' => 'form-control', 'placeholder' => 'Status']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('job_id', $job_titles, null, ['class' => 'form-control', 'placeholder' => 'Jabatan']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    {!! Form::label('manager_id','Manajer :',['class' => 'col-sm-5 control-label']) !!}
                                    <div class="col-sm-7">
                                        {!! Form::select('manager_id', $employees, null, ['class' => 'form-control  select2', 'placeholder' => 'Manajer']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('employee_status_id', $employee_statuses, null, ['class' => 'form-control', 'placeholder' => 'Status Karyawan']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group {{$errors->has('account_name')?'has-error':''}}">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text('account_name',null, ['class' => 'form-control', 'placeholder' => 'Nama Pemilik Akun']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('bank_id', $banks, null, ['class' => 'form-control', 'placeholder' => 'Bank']) !!}
                                    </div>
                                </div>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group {{$errors->has('remark')?'has-error':''}}">
                                    ...
                                    {!! Form::textarea('remark',null, ['class' => 'form-control', 'placeholder' => 'Keterangan']) !!}
